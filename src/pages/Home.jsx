    ...
    return (
        <>
            <section id="home" className="">
                <div className="flex flex-col justify-center p-6 mx-auto sm:py-12 lg:py-24 lg:flex-row lg:justify-between bg-violet-950">
                    <div className="flex flex-col justify-center p-6 text-center  lg:text-left">
                        <div className="">
                            <div className="mb-[.7rem] ">
                                <h1 className="text-5xl font-bold  sm:text-6xl">
                                    Hey, Im <span className="text-[#FC4370]">Ashish</span>
                                </h1>
                            </div>
                            <div className="my-[2rem]">
                                <h1 className="text-5xl font-bold  sm:text-5xl">
                                    a <span className="text-[#FC4370]">self-taught</span>
                                </h1>
                            </div>
                        ...
                        <div
                            ...
                            <a
                                href="https://github.com/Ashish-Dhami/blogPost"
